...
while deltaTf < Trange
    ...
    k1 = helper(Af(i-1), Omegas);
    k2 = helper(Af(i-1)+step/2*k1, Omegas);
    k3 = helper(Af(i-1)+step/2*k2, Omegas);
    k4 = helper(Af(i-1)+step*k3, Omegas);
...
while deltaTb < Trange
    ...
    k1 = helper(Ab(i-1), Omegas);
    k2 = helper(Ab(i-1)+step/2*k1, Omegas);
    k3 = helper(Ab(i-1)+step/2*k2, Omegas);
    k4 = helper(Ab(i-1)+step*k3, Omegas);
