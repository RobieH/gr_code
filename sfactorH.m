...
%   a(now) = 1).  
%
%   Requires a helper function (denoted helper below).  This function
...
Omegas = [Or, Om, Ov]; %vector of omegas for helper function
...
while deltaTf < Trange
    ...
    k1 = heavisideW(Af(i-1), Omegas);
    k2 = heavisideW(Af(i-1)+step/2*k1, Omegas);
    k3 = heavisideW(Af(i-1)+step/2*k2, Omegas);
    k4 = heavisideW(Af(i-1)+step*k3, Omegas);
...
while deltaTb < Trange
    ...
    k1 = heavisideW(Ab(i-1), Omegas);
    k2 = heavisideW(Ab(i-1)+step/2*k1, Omegas);
    k3 = heavisideW(Ab(i-1)+step/2*k2, Omegas);
    k4 = heavisideW(Ab(i-1)+step*k3, Omegas);
